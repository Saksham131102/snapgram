...
// Query was running on version 13.0.0, not on higher versions.
// So, I had to downgrade appwrite to the version of 13.0.0
...
export async function getCurrentUser() {
  try {
    ...
    /* Query was not running. It was giving error. */
    /* So, I wrote a for loop separately to get the
     * current logged user. */
    ...
    // EDIT : Query was running on version 13.0.0 
...
export async function getRecentPosts() {
  ...
  // Query was running on version 13.0.0
